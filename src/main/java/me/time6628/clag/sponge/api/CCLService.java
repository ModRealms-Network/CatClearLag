...
public class CCLService {
    ...
    public CCLService() {
        ...
        checks.put(Type.ITEM, notAPlayer().and(o -> o instanceof Item && o.get(Keys.DESPAWN_DELAY).isPresent() &&
                o.get(Keys.DESPAWN_DELAY).get() < CatClearLag.instance.getCclConfig().itemDespawnRate).and(itemWhitelistCheck));
        ...
        checks.put(Type.NAMED, notAPlayer().and(entity -> !entity.get(Keys.DISPLAY_NAME).isPresent() &&
                ...
                !entity.get(Keys.TAMED_OWNER).isPresent()).and(entityWhitelist));
